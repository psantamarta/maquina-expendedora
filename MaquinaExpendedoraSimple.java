public class MaquinaExpendedoraSimple {
    ...
    public MaquinaExpendedoraSimple( int costeDelBillete, String CiudadDeDestino ) {
        precioBillete = costeDelBillete;
        balanceClienteActual = 0;
        totalDineroAcumulado = 0;
        estacionOrigen = "Leon";
        estacionDestino = CiudadDeDestino;
    ...
    public void CambiarPrecioDelBillete ( int PrecioBilleteCambiado ) {
    ...
    public void vaciarDepositoDinero (int Devolucion) {
        totalDineroAcumulado = 0;
